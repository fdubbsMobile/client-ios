...
- (void)setNavigationBarTitleFontColor:(UIColor *)navigationBarTitleFontColor
{
    _navigationBarTitleFontColor = navigationBarTitleFontColor;
}

- (void)setNavigationBarSubtitleFontColor:(UIColor *)navigationBarSubtitleFontColor
{
    _navigationBarSubtitleFontColor = navigationBarSubtitleFontColor;
}
